(() => {
    ...
    function functions_scroll() {
        if (window.innerWidth > 768) window.addEventListener("scroll", (function() {
            if (scrollY > 50) document.querySelector(".header__bot").classList.add("header__bot-fixed"); else document.querySelector(".header__bot").classList.remove("header__bot-fixed");
        }));
    }
    class Popup {
        constructor(options) {
    ...
    function initSliders() {
        if (document.querySelector(".clients__slider")) new core(".clients__slider", {
            ...
            navigation: {
                prevEl: ".clients__arrows .clients__arrow_type_prev",
                nextEl: ".clients__arrows .clients__arrow_type_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".works__slider")) new core(".works__slider", {
            ...
            navigation: {
                prevEl: ".works__arrows .works__arrow_type-prev",
                nextEl: ".works__arrows .works__arrow_type-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
            ...
            navigation: {
                prevEl: ".reviews__arrows .reviews__arrow_type-prev",
                nextEl: ".reviews__arrows .reviews__arrow_type-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
